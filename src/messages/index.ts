export default{
  helpMessage:
    ...
    "➼*!help*: para solicitar essa mensagem de ajuda;\n" +
    "➼*!create, <SQUAD_NAME>*: cria um canal de texto e voz para seu squad " +
    "utilizar durante o processo seletivo. O Comando e o nome passado " +
    "em seguida devem, necessariamente, estar separados por vírgula. " +
    ...
    "➼*!join, <SQUAD_ID>*: você vai utilizar esse comando para entrar no "+
    "squad criado pelo *!create*. Até mesmo o criador do time deverá " + 
    "utilizá-lo.\n\n" +
